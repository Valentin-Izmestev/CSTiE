...
let path = {
    ...
    build:{
        html: project_folder +"/",
        css: project_folder + "/local/templates/cstie/css/",
        js: project_folder +"/local/templates/cstie/js/",
        img: project_folder +"/local/templates/cstie/img/",
        image: project_folder +"/local/templates/cstie/image/",
        fonts: project_folder +"/local/templates/cstie/fonts/"
    },
    //исходники
    src:{ 
        html: [source_folder +"/*.html", "!" + source_folder +"/_*.html"],
        scss: source_folder +"/local/templates/cstie/scss/style.scss",
        js: source_folder +"/local/templates/cstie/js/script.js",
        img: source_folder +"/local/templates/cstie/img/**/*.{jpg,png,svg,gif,ico,webp,jpeg}",
        image: source_folder +"/local/templates/cstie/image/**/*.{jpg,png,svg,gif,ico,webp,jpeg}",
        fonts: source_folder + "/local/templates/cstie/fonts/**/*.{eot,ttf,woff,woff2,svg}"
    },
    // пути папок за которыми нужно будет следить
    watch:{
        html: source_folder +"/**/*.html",
        scss: source_folder +"/local/templates/cstie/scss/**/*.scss",
        js: source_folder +"/local/templates/cstie/js/**/*.js",
        img: source_folder +"/local/templates/cstie/img/**/*.{jpg,png,svg,gif,ico,webp,jpeg}",
        image: source_folder +"/local/templates/cstie/image/**/*.{jpg,png,svg,gif,ico,webp,jpeg}",
        fonts: source_folder + "/local/templates/cstie/fonts/**/*.{eot,ttf,woff,woff2,svg}"
    },
...
gulp.task('svgSprite', function(){ 
    return gulp.src('src/local/templates/cstie/img/for-svg-icon/*.svg')
        .pipe(svgSprite({
            mode:{
                stack:{
        ...
        .pipe(dest('src/local/templates/cstie/img/'))
});
